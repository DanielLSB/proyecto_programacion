...
CREATE TABLE `compras` (
  ...
  CONSTRAINT `id_compra_compra_proveedores` FOREIGN KEY (`id_proveedor`) REFERENCES `proveedores` (`id_proveedor`) ON DELETE RESTRICT ON UPDATE CASCADE
...
CREATE TABLE `compras_detalle` (
  ...
  CONSTRAINT `id_compra_detalle_compra_detalle_compras` FOREIGN KEY (`id_compra`) REFERENCES `compras` (`id_compra`) ON DELETE CASCADE ON UPDATE CASCADE,
...
INSERT INTO `compras_detalle` VALUES (1,1,2,10,10.00,NULL),(2,2,1,10,5.00,NULL),(3,3,3,20,12.00,NULL),(4,4,4,40,1.00,NULL),(5,5,5,50,1.00,NULL),(6,6,2,3,3.00,9.00),(7,6,3,4,5.00,20.00),(8,7,3,4,3.00,12.00),(9,7,2,3,3.00,9.00),(10,8,2,3,4.00,12.00),(11,8,2,3,4.00,12.00),(12,8,3,4,5.00,20.00);
...
CREATE TABLE `ventas` (
  ...
  CONSTRAINT `id_venta_venta_clientes` FOREIGN KEY (`id_cliente`) REFERENCES `clientes` (`id_cliente`) ON UPDATE CASCADE,
...
CREATE TABLE `ventas_detalle` (
  ...
  CONSTRAINT `id_venta_detalle_venta_detalle_venta` FOREIGN KEY (`id_venta`) REFERENCES `ventas` (`id_venta`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2021-06-07 15:40:12
