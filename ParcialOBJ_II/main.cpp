...
if (op1 == 5) { system("cls"); main(); }
	...
	case 7:
		...
		cout << "1. MOSTRAR VENTA_DETALLE" << endl;
...
v.autoNit(id_auxNit);
		...
		if (op1 == 4) { 
			system("cls"); 
			cout << "ingrese id de venta a eliminar: " << endl;
			cin >> id_aux;
			Ventas v1 = Ventas(no_factura, serie, fecha_factura, id_cliente, id_empleado, fecha_ingreso);
			v1.deletV(id_aux);
			system("pause");
	...
	case 8:
		do {
			...
			cout << "1. MOSTRAR COMPRA DETAELLE" << endl;
			cout << "2. INGRESAR COMPRAS/DETALLE" << endl;
			cout << "3. MOSTRAR COMOPRAS" << endl;
			cout << "4. ELIMINAR" << endl;
			cout << "5. SALIR" << endl;
